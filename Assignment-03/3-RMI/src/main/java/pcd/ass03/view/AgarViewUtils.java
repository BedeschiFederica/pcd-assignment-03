...
public class AgarViewUtils implements Remote {
    ...
    private static PositioningInfo getPositioningInfo(final Entity entity, final double offsetX, final double offsetY) throws RemoteException {
    ...
    public static void drawWorld(final Graphics2D g, final World world, final double offsetX, final double offsetY) throws RemoteException {
        // Draw foods
